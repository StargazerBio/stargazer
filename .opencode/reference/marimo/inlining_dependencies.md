...
to the script metadata. Removing an import does *not* remove it from the script
...
format](https://docs.marimo.io/guides/editor_features/watching/#as-markdown) under the
