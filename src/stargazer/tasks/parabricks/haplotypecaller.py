"""
HaplotypeCaller task for Stargazer.

Calls germline variants from aligned BAM using GATK HaplotypeCaller.
"""
...
async def haplotypecaller(
    ...
    """
    Call variants from aligned BAM using GATK HaplotypeCaller.

    Uses Parabricks HaplotypeCaller (GPU-accelerated GATK HaplotypeCaller).
    ...
    Example:
        ...
        variants = await haplotypecaller(alignment=alignment, ref=ref)
    ...
    output_vcf = output_dir / f"{alignment.sample_id}_haplotypecaller.{vcf_ext}"
